        ...
        <div className="Works__posts">
          <Fade top>
            <div className="Works__post">
              <a
                href="https://tranquil-sands-29987.herokuapp.com/index"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={Radostinki} alt="" className="Works__post__img" />
              </a>
            ...
            <div className="Works__post">
              <a
                href="https://diomavytrykush.github.io/Parallax/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={Parallax} alt="" className="Works__post__img" />
              </a>
              <div className="Works__post__content">
                <h3>Parallax</h3>
                <h4>React.js</h4>
            ...
            <div className="Works__post">
              <a
                href="https://printstudio.herokuapp.com/shop"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={Print} alt="" className="Works__post__img" />
              </a>
              <div className="Works__post__content">
                <h3>Online-store</h3>
